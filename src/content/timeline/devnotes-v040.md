---
title: "开发笔记 v0.4.0：提示词库 - 搜索与标签筛选"
date: '2026-07-25'
updated: '2026-07-25'
description: 'DevNotes 新增第五个独立页面「提示词库」，并把博客/提示词库列表统一升级为可搜索 + 标签筛选的形态。'
subcategory: [架构]
category: 开发笔记
---
...
![开发笔记 v0.4.0 历史提示词库 UI](/images/timeline/devnotes-v040/ui-01.png)
